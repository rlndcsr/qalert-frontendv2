  ...
  return (
    <div className="bg-white/95 rounded-xl border border-slate-300/70 shadow-sm overflow-hidden flex flex-col max-md:h-auto md:h-full min-h-0">
      ...
      >
        {nowServingPatient ? (
          <div
            className={`flex flex-col items-center justify-center gap-0.5 -mt-[4px] rounded-lg bg-gradient-to-br from-teal-400 to-cyan-300 ${compact ? "min-h-[3.5rem] px-2 py-1.5" : "min-h-[5rem] px-3 py-2"}`}
          >
            <p
