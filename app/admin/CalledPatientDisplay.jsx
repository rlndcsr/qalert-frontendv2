  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-[#25323A]">Called Patient</h2>
      </div>
      {calledPatient ? (
        <div className="flex gap-4">
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Queue #{String(calledPatient.queue_number).padStart(3, "0")}
                </p>
              </div>
              <span
            ...
            <p className="text-sm text-gray-700 mb-3">{calledPatient.reason}</p>
              ...
              onChange={async (e) => {
                ...
                try {
                  ...
                  setQueues((prevQueues) =>
                    prevQueues.map((q) =>
                      q.queue_entry_id === calledPatient.queue_entry_id
